...
module.exports = merge(common, {
  ...
  // If webpack or webpack-dev-server are launched with the --hot option, this plugin
  // will be added automatically, so you may not need to add this to your webpack.config.js.
